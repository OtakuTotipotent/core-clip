...
export default function PlansPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <h1 className="text-3xl font-semibold text-pink-500 mb-4">Plans</h1>
      <p className="text-gray-300 mb-8">
        Choose a plan and keep creating with CoreClip.
      </p>
      <div className="grid gap-6 md:grid-cols-3">
        {plans.map((plan) => (
          ...
          >
            <h2 className="text-xl font-semibold text-pink-500">{plan.name}</h2>
            <p className="mt-3 text-gray-300">{plan.description}</p>
            <div className="mt-6 text-4xl font-semibold text-gray-300">
              {plan.price}
            </div>
